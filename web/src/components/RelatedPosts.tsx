...
const posts: BlogPost[] = [
  ...
  },
  {
    ...
    titleEn: 'RAG vs Fine-Tuning vs Identity Layer: The AI Personalization Trilemma',
    excerpt: 'RAG 喂文档，Fine-Tuning 改模型，Identity Layer 建模身份——三种 AI 个性化方案各有致命缺陷。',
  ...
  },
  {
    ...
    excerpt: '为什么你的 AI Agent 有了记忆还是不认识你？深度剖析 Identity Layer 和 Memory Layer 的本质差异。',
  ...
  },
  {
    ...
    excerpt: '每天早上打开 Claude，它都像第一次见你。不是 AI 笨，是你的身份数据从没被真正存储过。',
    tags: ['痛点', 'Identity', '教程'],
  },
  {
  ...
  },
  {
    ...
    excerpt: '现代 AI Agent 开发者需要哪些工具？LLM 网关、向量数据库、记忆层、身份层、MCP 服务器。',
    tags: ['工具链', '生态', '架构'],
  },
  {
  ...
  },
  {
    ...
    excerpt: 'Memory 赛道拥挤，但 Identity 赛道几乎无人。',
