...
const posts: BlogPost[] = [
  ...
  },
  {
    ...
    titleEn: 'RAG vs Fine-Tuning vs Soul Backup: The AI Personalization Trilemma',
    excerpt: 'RAG 喂文档，Fine-Tuning 改模型，灵魂备份保底——三种 AI 个性化方案各有边界。',
  ...
  },
  {
    ...
    excerpt: '为什么你的 AI Agent 有了记忆，换台电脑还是全丢？深度剖析灵魂资产备份和记忆层的本质差异。',
  ...
  },
  {
    ...
    excerpt: '每天早上打开 Claude，它都像第一次见你。不是 AI 笨，是你的调教成果从没被真正备份过。',
    tags: ['痛点', 'Identity', '教程'],
  },
  {
  ...
  },
  {
    ...
    excerpt: '现代 AI Agent 开发者需要哪些工具？LLM 网关、向量数据库、记忆层、灵魂资产备份层、MCP 服务器。',
    tags: ['工具链', '生态', '架构'],
  },
  {
  ...
  },
  {
    ...
    excerpt: 'Memory 赛道拥挤，但 备份赛道几乎无人。',
