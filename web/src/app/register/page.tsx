      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleRegister} className="space-y-3">
          <input type="email" placeholder={a.emailPlaceholder} value={email}
            ...
            style={{ background: '#16161a', color: '#ffffff', boxShadow: '0 0 0 1px rgba(255,255,255,0.08)', fontWeight: 400 }}
        ...
        <p className="text-sm text-center mt-6" style={{ color: '#888888' }}>
          {a.hasAccount} <a href="/login" style={{ color: '#00c030' }} className="hover:underline">{a.goLogin}</a>
        </p>
      </div>
    </div>
  )
