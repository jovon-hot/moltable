...
const comparisonData = {
  zh: {
    ...
    pricing: {
      title: '定价对比',
      moltable: { free: '100 条记忆 / 2 Persona', pro: '30 天免费试用', team: '联系销售' },
  ...
  en: {
    ...
    pricing: {
      ...
      moltable: { free: '100 memories / 2 Personas', pro: '30-day free trial', team: 'Contact sales' },
    ...
    strengths: {
      ...
      moltable: [
        ...
        'MIT open-source + 30-day free trial',
