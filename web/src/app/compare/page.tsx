  ...
  zh: {
    ...
    features: {
      ...
      rows: [
        ...
        { feature: '时间衰减记忆', moltable: true, mem0: false, zep: false },
        { feature: '记忆去重', moltable: true, mem0: false, zep: false },
        { feature: '图记忆 / 知识图谱', moltable: false, mem0: false, zep: true },
        { feature: 'MCP Server', moltable: true, mem0: true, zep: false },
        { feature: '多 Agent 支持', moltable: true, mem0: true, zep: true },
        { feature: '端到端加密', moltable: true, mem0: false, zep: false },
        { feature: '自托管 (Self-host)', moltable: true, mem0: true, zep: true },
        { feature: 'DID / 可验证凭证', moltable: true, mem0: false, zep: false },
        { feature: 'CLI 工具', moltable: true, mem0: true, zep: true },
        { feature: 'Web Dashboard', moltable: true, mem0: false, zep: true },
      ],
    },
    pricing: {
      title: '定价对比',
      moltable: { free: '100 条记忆 / 2 Persona', pro: '¥19/月 (10K 记忆)', team: '联系销售' },
      mem0: { free: '开源免费', pro: '$249/月', team: '企业定制' },
      zep: { free: '开源免费', pro: '$99/月起', team: '企业定制' },
    },
    architecture: {
      title: '架构对比',
      moltable: 'Identity → Persona → Agent 三层架构。以「身份」为原子单位，Persona 提供多角色切换，Agent 层负责 MCP 协议分发。端到端加密，数据完全由用户控制。',
  ...
  en: {
    ...
    features: {
      ...
      rows: [
        ...
        { feature: 'Time-Decay Memory', moltable: true, mem0: false, zep: false },
        { feature: 'Memory Deduplication', moltable: true, mem0: false, zep: false },
        { feature: 'Graph Memory / Knowledge Graph', moltable: false, mem0: false, zep: true },
        { feature: 'MCP Server', moltable: true, mem0: true, zep: false },
        { feature: 'Multi-Agent Support', moltable: true, mem0: true, zep: true },
        { feature: 'End-to-End Encryption', moltable: true, mem0: false, zep: false },
        ...
        { feature: 'CLI Tool', moltable: true, mem0: true, zep: true },
        { feature: 'Web Dashboard', moltable: true, mem0: false, zep: true },
      ],
    },
    pricing: {
      title: 'Pricing Comparison',
      moltable: { free: '100 memories / 2 Personas', pro: '¥19/mo (10K memories)', team: 'Contact sales' },
      mem0: { free: 'OSS free', pro: '$249/mo', team: 'Enterprise custom' },
      zep: { free: 'OSS free', pro: 'From $99/mo', team: 'Enterprise custom' },
    },
    architecture: {
      title: 'Architecture Comparison',
      moltable: 'Identity → Persona → Agent three-layer architecture. Identity as the atomic unit, Persona for multi-role switching, Agent layer for MCP protocol distribution. End-to-end encryption, full user data control.',
    ...
    usecases: {
      ...
      moltable: [
        ...
        'Privacy-conscious: need end-to-end encryption and self-hosting',
  ...
  return (
    <div className="min-h-screen bg-ln-bg text-ln-text">
              ...
              <div key={key} className="p-6 rounded-card bg-ln-panel relative"
                style={{
                  boxShadow: isMoltable
                    ? '0 0 0 1px #7170ff, 0 4px 24px rgba(113,112,255,0.12)'
          ...
          {(['moltable', 'mem0', 'zep'] as const).map((key) => {
            ...
            return (
              <div key={key} className="p-6 rounded-card bg-ln-panel"
                style={{ boxShadow: isMoltable ? '0 0 0 1px #7170ff' : '0 0 0 1px rgba(255,255,255,0.06)' }}>
      ...
      <section className="max-w-3xl mx-auto px-6 pb-12">
        ...
        <div className="p-6 rounded-card bg-ln-panel" style={{ boxShadow: '0 0 0 1px rgba(113,112,255,0.3)' }}>
