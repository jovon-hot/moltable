...
export default function PricingPage() {
  ...
  const plans = [
    ...
    {
      name: plansData?.ultra?.name || p.ultra.name,
      price: paid ? fmtUsd(plansData.ultra.price_monthly) : p.ultra.priceMonthly,
      desc: p.ultra.desc,
      cta: p.ultra.cta,
      href: '/register?plan=pro',
      features: plansData?.ultra?.features || pricingFeatures.ultra || [],
    },
  ]
