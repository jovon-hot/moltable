      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-3">
          <input type="email" placeholder={a.emailPlaceholder} value={email}
            ...
            style={{ background: '#14141E', color: '#fff', boxShadow: '0 0 0 1px rgba(255,255,255,0.08)', fontWeight: 400 }}
        ...
        <p className="text-sm text-center mt-6" style={{ color: '#888888' }}>
          {a.noAccount} <a href="/register" style={{ color: '#4338CA' }} className="hover:underline">{a.goRegister}</a>
        </p>
      </div>
    </div>
  )
