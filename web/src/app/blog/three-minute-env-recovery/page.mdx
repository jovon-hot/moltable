export const meta = {
  ...
  date: '2026-08-04',
  description: '每一台新设备都是一次身份重置。本文是 Moltable 的完整实战指南：从安装到恢复、从单机到多 Agent 同步，3 分钟让你的 Persona、偏好记忆与工具配置在新电脑上全部就位。',
  tags: ['换机', '环境恢复', 'Persona', '实战指南', 'Moltable'],
...
对于个人开发者，Free 套餐（100 条记忆、2 个 Persona）足够日常开发。跨项目、团队协作需要 Pro（¥19/月，10,000 条记忆）。
...
GitHub: [jovon-hot/moltable](https://github.com/jovon-hot/moltable) · MIT License
