export const meta = {
  ...
  date: '2026-08-06',
  description: 'Vector DBs store facts; identity graphs store context. That\'s why vector search alone can\'t give AI agents persistent identity — here\'s the fix.',
