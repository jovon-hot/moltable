...
export const metadata: Metadata = {
  ...
  description:
    '2026年3月 arXiv 论文提出多锚点身份理论：参考人类记忆障碍的神经科学研究，论证 AI Agent 需要偏好、决策、关系、价值观、叙事五个锚点来维持持续身份。Moltable 的 Agent 在线同步完整落地了这一理论。',
  keywords: [
    'AI持续身份',
    'Agent身份锚点',
    'arXiv论文解读',
  ...
  openGraph: {
    ...
    description:
      '2026年3月 arXiv 论文提出多锚点身份理论：五个锚点维持 AI Agent 持续身份。Moltable Agent 在线同步完整落地了这一理论。',
