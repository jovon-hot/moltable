...
export const metadata: Metadata = {
  ...
  description:
    '每天早上打开 Claude，它都像第一次见你。不是 AI 笨，是你的身份数据从没被真正存储过。本文剖析 AI「失忆」的五个根因——偏好重置、项目上下文丢失、工具配置消失、Persona 被遗忘、无限自我介绍，并给出 Moltable 的三层身份架构解决方案：一次配置，所有 Agent 共享。',
  keywords: [
    'AI失忆',
    'AI记忆',
    'AI身份',
  ...
  twitter: {
    ...
    description: '不是 AI 笨，是你的身份数据从没被真正存储过。AI 失忆的五个根因与终极解决方案。',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              '每天早上打开 Claude，它都像第一次见你。本文剖析 AI「失忆」的五个根因，并给出 Moltable 的三层身份架构解决方案——一次配置，所有 Agent 共享。',
