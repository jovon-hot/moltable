...
const posts: BlogPost[] = [
  ...
  },
  {
    ...
    titleEn: 'Pinecone Hands-On: Adding Managed Vector Search to Your Agent Soul Backup',
    excerpt:
      '承接「记忆全家桶」的结论，这篇动手把 Pinecone 接进 Moltable：384 维对齐、namespace 租户硬隔离、metadata 过滤，事实源留 Postgres、语义检索下沉托管云。附四步可照抄代码与「什么时候该上 Pinecone」的诚实判断标准。',
  ...
  },
  {
    ...
    excerpt:
      'LangChain Memory、Chroma、Pinecone 与 Moltable 都自称「记忆」，却解决四个不同问题：上下文管理、向量检索、托管检索、灵魂资产备份。一张对比表 + 决策指南，帮你一次选对。',
  ...
  },
  {
    ...
    excerpt:
      '一个人同时用 Claude Code、OpenCode、Hermes 等多个 AI Agent，最耗精力的不是写 prompt，而是重复交代「我是谁」。一份真实的工具链使用记录：瓶颈不在模型层，而在跨 Agent 灵魂资产备份。',
  ...
  },
  {
    ...
    titleEn: 'RAG vs Fine-Tuning vs Soul Backup: The AI Personalization Trilemma and How to Solve It',
    excerpt:
      'RAG 喂文档，Fine-Tuning 改模型，灵魂备份保底——三种 AI 个性化方案各有致命缺陷。本文从架构哲学、成本模型、时效性和准确度四个维度，深度分析 AI 个性化的「不可能三角」，并给出三层组合架构的最佳实践。',
  ...
  },
  {
    ...
    excerpt:
      '我们分析了 200+ 开发者的 AI 使用习惯，发现平均每人每周浪费 3.2 小时在「重新教 AI 认识自己」上。本文用真实数据量化 AI 失忆的隐性成本，并给出零摩擦的灵魂资产备份解决方案。',
    tags: ['研究', '效率', '数据', 'Identity'],
  },
  {
    slug: 'moltable-vs-zep-temporal-memory',
    date: '2026-08-06',
    title: 'Moltable vs Zep：时序记忆与灵魂备份 —— 谁赢得 Agent 记忆竞赛？',
    titleEn: 'Moltable vs Zep: Temporal Memory vs Soul Backup — Who Wins the Agent Memory Race?',
    excerpt:
      'Zep 用企业级时序知识图谱定义了时序记忆赛道，Moltable 用 灵魂资产备份给出了不同答案——版本快照、增量去重、跨框架迁移。从能力、架构、定价到适用场景，一文看懂该选谁。',
    tags: ['对比', 'Zep', '时序记忆', 'Identity'],
  },
  {
    slug: 'moltable-vs-mem0-identity-vs-memory',
    date: '2026-08-05',
    title: 'Moltable vs mem0：灵魂备份和记忆层的本质区别',
    titleEn: 'Moltable vs mem0: Soul Backup vs Memory Layer — The Essential Difference',
    excerpt: '为什么你的 AI Agent 有了记忆，换台电脑还是全丢？本文从架构哲学、数据模型、多 Agent 协作三个维度，深度剖析灵魂资产备份和记忆层的本质差异，帮你做出正确的技术选型。',
  ...
  },
  {
    ...
    excerpt: '每天早上打开 Claude，它都像第一次见你。不是 AI 笨，是你的调教成果从没被真正备份过。本文剖析 AI「失忆」的五个根因，并给出 Moltable 的灵魂资产备份解决方案——一次配置，所有 Agent 共享。',
    tags: ['痛点', 'Identity', '教程'],
  },
  {
    ...
    excerpt: '换一台新 Mac 之后，Claude、Cursor、Codex 全部失忆了？本文手把手教你用 Moltable 在 3 分钟内恢复完整的 AI 工作环境——从 SOUL 到 MCP 配置，从记忆到技能偏好，一条命令全搞定。',
  ...
  },
  {
    ...
    excerpt: '2026年3月 arXiv 论文提出多锚点身份理论：参考人类记忆障碍的神经科学研究，论证 AI Agent 需要偏好、决策、关系、价值观、叙事五个锚点来维持持续身份。Moltable 的灵魂资产备份恰好完整落地了这一理论。',
    tags: ['研究', 'Identity', '架构', '论文解读'],
  },
  {
    slug: 'ai-agent-trends-2026h2',
    date: '2026-08-06',
    title: '2026 下半年 AI Agent 趋势：从工具到伙伴，从记忆到备份',
    titleEn: 'AI Agent Trends H2 2026: From Tools to Partners, Memory to Backup',
    excerpt: '回顾 2026 上半年 AI Agent 的关键进展，预测下半年的五大趋势——包括 灵魂资产备份的崛起、MCP 普及、开源追赶和价格战。',
    tags: ['趋势', '预测', 'Agent'],
  },
  {
    slug: 'open-protocol-ai-ecosystem',
    date: '2026-08-05',
    title: '开源协议如何重塑 AI 生态：MCP、A2A 与灵魂资产',
    titleEn: 'How Open Protocols Reshape AI: MCP, A2A and the Soul Asset Layer',
    excerpt: 'Google A2A 和 Anthropic MCP 两大 AI 协议正在交织出一张新的生态网。灵魂资产层将在其中扮演什么角色？',
    tags: ['MCP', 'A2A', '开源', '生态'],
  },
  {
    slug: 'ai-developer-toolchain',
    date: '2026-08-01',
    title: '2026 AI 开发者工具链全景：从 LLM 到灵魂备份的完整技术栈',
    titleEn: '2026 AI Developer Toolchain: Full Stack from LLM to Soul Backup',
    excerpt: '现代 AI Agent 开发者需要哪些工具？LLM 网关、向量数据库、记忆层、灵魂资产备份层、MCP 服务器——一文梳理完整技术选型。',
    tags: ['工具链', '生态', '架构'],
  },
  {
  ...
  },
  {
    ...
    date: '2026-07-25',
    title: '换电脑不换灵魂：Agent 灵魂备份完全指南',
    titleEn: 'New Computer, Same Soul: The Complete Agent Soul Backup Guide',
    excerpt: '换一台新电脑，AI 又要从零开始认识你？这份指南教你用 Moltable 备份命令实现跨设备 AI 环境一键恢复。',
  ...
  },
  {
    ...
    titleEn: 'Enterprise Agent Personas: One Team, Ten Minds — Backed Up',
    excerpt: '当整个团队共用同一套 AI 工具时，如何让市场总监看到激进分析、财务总监看到保守建议？把每个角色作为独立备份源治理的企业级方案。',
  ...
  },
  {
    ...
    titleEn: 'Cross-Platform Personas: One Identity, Many Minds — Backed Up',
    excerpt: '同一个 AI，加载战略顾问 Persona 是麦肯锡风格，加载保守审核员 Persona 是合规导向。本文通过真实场景演示如何把每个化身作为独立备份源，让多种思维模式都不丢失。',
  ...
  },
  {
    ...
    titleEn: 'From Memory to Backup: Designing the Agent Soul Asset Layer',
    excerpt: 'Memory 赛道拥挤，但「备份」赛道几乎无人。本文探讨为什么"身份"比"记忆"更适合作为 AI 个人化的原子单位，以及 Moltable 的 Profile→Soul→凭证 三层架构设计。',
