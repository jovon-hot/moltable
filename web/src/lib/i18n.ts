...
export const translations = {
  zh: {
    ...
    pricing: {
      ...
      pro: {
        name: 'Pro', priceMonthly: '免费 30 天', priceYearly: '', priceYearlyMonthly: '',
        desc: '30 天免费试用全部 Pro 功能 · Stripe 支付即将上线',
        descShort: '全功能体验 · 30 天免费',
        cta: '🔥 免费试用 30 天', ctaYearly: '', badge: '30天免费',
      },
      team: {
  ...
  en: {
    ...
    pricing: {
      title: 'Pricing',
      subtitle: '30-day free trial · No credit card · Cancel anytime',
      monthly: 'Free Trial',
      yearly: 'Coming Soon',
      savePercent: '',
      ...
      pro: {
        name: 'Pro · Free Trial', priceMonthly: 'Free 30 days', priceYearly: '', priceYearlyMonthly: '',
        desc: '30-day free trial of all Pro features · Stripe billing coming soon',
        descShort: 'Full features · 30-day trial',
