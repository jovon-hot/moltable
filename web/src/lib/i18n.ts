...
export const translations = {
  zh: {
    ...
    pricing: {
      ...
      pro: {
        name: 'Pro', priceMonthly: '免费 90 天', priceYearly: '', priceYearlyMonthly: '',
        desc: '90 天免费试用全部 Pro 功能 · Stripe 支付即将上线',
  ...
  en: {
    ...
    hero: {
      ...
      trust: 'No credit card · 90-day free trial',
    ...
    pricing: {
      ...
      pro: {
        name: 'Pro · Free Trial', priceMonthly: 'Free 90 days', priceYearly: '', priceYearlyMonthly: '',
        desc: '90-day free trial of all Pro features · Stripe billing coming soon',
    ...
    dashboard_ui: {
      ...
      upgrading: '激活中...',
      y149year: 'Activate 90-Day Pro Free',
      ...
      proFeature6: '90 days free · No credit card',
