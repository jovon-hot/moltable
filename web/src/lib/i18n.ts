...
export const translations = {
  zh: {
    ...
    pricing: {
      ...
      team: {
        ...
        desc: '团队功能 · 联系 hi@moltable.ai 开通',
        descShort: '团队协作',
        cta: '联系咨询',
      },
      features: {
    ...
    dashboard_ui: {
      ...
      trialBannerSub: '解锁 100 个备份源、50GB 存储、引用同步等全部 Pro 功能',
      trialBannerCta: '立即激活',
      trialActive: 'Pro 体验中',
  ...
  en: {
    ...
    dashboard_ui: {
      ...
      trialBannerSub: 'Unlock 100 backup sources, 50GB storage, reference sync, and all Pro features',
